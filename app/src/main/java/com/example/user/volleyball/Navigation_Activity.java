...
/**
 * Created by dingjie on 2017/12/18.
 */
...
public class Navigation_Activity extends AppCompatActivity {
    ...
    public void setContentView(@LayoutRes int layoutResID) {
        DL = (DrawerLayout) getLayoutInflater().inflate(R.layout.navigation, null);
                ...
                if(!(menuItem == NV.getMenu().getItem(CurrentMenuItem))) {//判斷使者者是否點擊當前畫面的項目，若不是，根據所按的項目做出分別的動作
                    switch (menuItem.getItemId()) {
                        case R.id.volleyball:
                            ...
                            intent.setClass(Navigation_Activity.this, Start.class);
                        ...
                        case R.id.detail:
                            ...
                            intent2.setClass(Navigation_Activity.this, MainActivity.class);
                        ...
                        case R.id.edit:
                            /*Intent intent2 = new Intent();
                            intent2.setClass(Navigation_Activity.this, About.class);
                            startActivity(intent2);
                            overridePendingTransition(0, 0);
                            finish();*/
                            break;
                        case R.id.exit:
                            new AlertDialog.Builder(Navigation_Activity.this)
                                    .setTitle("Logout")
